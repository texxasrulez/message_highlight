...
(function($){
  ...
  $(document).ready(function () {
    ...
    $('.mh_color_input').mColorPicker({
        imageFolder: (window.rcmail && typeof rcmail.assets_path === 'function')
          ? rcmail.assets_path('plugins/message_highlight/colorpicker/images/')
          : 'plugins/message_highlight/colorpicker/images/',
